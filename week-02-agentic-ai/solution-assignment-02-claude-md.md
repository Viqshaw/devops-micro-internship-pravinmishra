...
![Claude](screenshots/claude-md-file-1-of-1.png)

![Claude](screenshots/claude-md-file-2-of-1.png)

![Claude](screenshots/claude-text-1.png)

![Claude](screenshots/claude-text-2.png)

![Claude](screenshots/claude-text-3.png)
...
![alt text](screenshots/updated-claude-file-3.png)

![alt text](screenshots/updated-claude-file-2.png)

![alt text](screenshots/updated-claude-file-3.png)

![alt text](screenshots/updated-claude-file-4.png)
...
![alt text](screenshots/project-about.png)

![alt text](screenshots/project-about-2.png)

---

#### Screenshot 5 — Claude refusing or warning against adding React because of the "No JavaScript" convention defined in CLAUDE.md

![alt text](screenshots/add-react.png)
...
`https://github.com/Viqshaw/Ultimate-Agentic-DevOps-with-Claude-Code.git`
