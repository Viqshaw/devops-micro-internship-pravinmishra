...
![alt text](screenshots/04.3.2-ec2.png)
...
![alt text](screenshots/04.4.1-software.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![alt text](screenshots/04.4.2-software.png)

---

#### Screenshot 10 — Output of `mysql --version`

![alt text](screenshots/04.4.3-software.png)
...
![alt text](screenshots/04.6.1-mysql.png)
...
![alt text](screenshots/04.8.1-nginx-t.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![alt text](screenshots/04.8.2-reverse-proxy.png)
