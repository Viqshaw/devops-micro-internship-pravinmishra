...
![alt text](screenshots/02.1.1-pwd.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![alt text](screenshots/02.1.2-git-status.png)
...
![alt text](screenshots/02.2.1-files.png)
...
![alt text](screenshots/02.3.1-content.png)
...
![alt text](screenshots/02.4.1-untracked.png)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![alt text](screenshots/02.4.2-tracked.png)
...
![alt text](screenshots/02.5.1-git-commit.png)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![alt text](screenshots/02.5.2-git-log.png)
...
![alt text](screenshots/02.6.1-index-html.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![alt text](screenshots/02.6.2-git-status.png)

---

#### Screenshot 11 — Output of `git commit`

![alt text](screenshots/02.6.3-git-commit.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![alt text](screenshots/02.6.4-git-log.png)
...
`https://www.linkedin.com/posts/tonye-bagshaw_dmi-devops-micro-internship-with-agentic-share-7487514344659005441-q01V/?utm_source=share&utm_medium=member_desktop&rcm=ACoAADZfZhcBxSczrU0SYBi3qw_ndXsq3CkHOck`

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![alt text](screenshots/02.8-linkedin.png)
