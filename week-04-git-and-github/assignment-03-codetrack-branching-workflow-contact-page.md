...
![alt text](screenshots/03.1.1-status.png)
...
![alt text](screenshots/03.2.1-new-branch.png)
...
![alt text](screenshots/03.3.1-ls.png)

---

#### Screenshot 4 — Output of `git commit`

![alt text](screenshots/03.3.2-git-commit.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![alt text](screenshots/03.3.3-git-log.png)
...
![alt text](screenshots/03.4.1-git-status.png)

---

#### Screenshot 7 — Output of `git commit`

![alt text](screenshots/03.4.2-git-commit.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![alt text](screenshots/03.6.3-contact-page.png)
...
![alt text](screenshots/03.6.1-git-merge.png)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![alt text](screenshots/03.6.2-ls.png)
...
![alt text](screenshots/03.7.1-git-log.png)
