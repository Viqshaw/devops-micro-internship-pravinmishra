...
![alt text](screenshots/05.0.1-forked.png)
...
![alt text](screenshots/05.1.1-auth.png)
...
![alt text](screenshots/05.2.1-git-remote.png)
...
![alt text](screenshots/05.3.1-git-status.png)

---

#### Screenshot 5 — Output of `git commit`

![alt text](screenshots/05.3.2-git-commit.png)
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/429`
...
`https://www.linkedin.com/posts/tonye-bagshaw_devops-git-github-ugcPost-7487517262694830080-LHxk/?utm_source=share&utm_medium=member_desktop&rcm=ACoAADZfZhcBxSczrU0SYBi3qw_ndXsq3CkHOck`

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![alt text](screenshots/05.6-Linkedin.png)
