...
![alt text](screenshots/02.1.1-Spaces.png)
...
![alt text](screenshots/02.2.1-Epic.png)
...
![alt text](screenshots/02.4.1-SubTask.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

![alt text](screenshots/02.4.2-SubTask.png)
...
![alt text](screenshots/02.5.1-Tags.png)

![alt text](screenshots/02.5.2-Tags.png)
...
![alt text](screenshots/02.6.1-Sprint.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![alt text](screenshots/02.6.2-Sprint.png)
...
![alt text](screenshots/02.7.2-Filter.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![alt text](screenshots/02.7.1-Filter.png)
...
![alt text](<screenshots/02.8.1-Burndown .png>)
