...
![alt text](screenshots/02.0.1-version.png)
...
![alt text](screenshots/02.1.1-provider.png)
...
![alt text](screenshots/02.1.2-ec2.png)
...
![alt text](screenshots/02.2.1-init.png)
...
**EC2 Public IP Address:** `44.220.10.76`
...
![alt text](screenshots/02.5.1-destroy.png)
